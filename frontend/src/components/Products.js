...
const Products = () => {
  ...
  const units = ['pièce', 'heure', 'jour', 'semaine', 'mois', 'kg', 'litre', 'mètre', 'forfait'];
  const categories = ['Développement', 'Design', 'Conseil', 'Formation', 'Maintenance', 'Produit', 'Service', 'Autre'];
  ...
  const handleDelete = async (productId) => {
    if (!window.confirm('Êtes-vous sûr de vouloir supprimer ce produit/service ?')) {
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Gérer votre catalogue de produits et services</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {products.length > 0 ? products.map((product) => (
          ...
          <div className="col-span-full text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Commencez par créer votre premier produit ou service</p>
            <button
              onClick={() => setShowModal(true)}
